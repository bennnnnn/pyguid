import type { AiTerminologyMeta } from "./types";

export const AI_TERMINOLOGY_META: AiTerminologyMeta = {
  title: "AI Terminology for Python Developers",
  subtitle:
    "Learn AI terms group by group, from beginner AI concepts to machine learning, deep learning, LLMs, RAG, agents, MCP, evaluation, and deployment vocabulary.",
  description:
