...
export const QUIZ_TOPICS: QuizTopic[] = [
  { slug: "what-is-python", chapter: 1, title: "What is Python?", description: "Why Python and how the course works." },
  {
  ...
  { slug: "variables", chapter: 3, title: "Variables", description: "Names, assignment, and using variables." },
  {
  ...
  { slug: "data-types", chapter: 5, title: "Data Types", description: "Types, isinstance, and mutability." },
  {
  ...
  { slug: "strings", chapter: 7, title: "Strings", description: "Create, slice, and transform text." },
  {
  ...
  { slug: "loops", chapter: 9, title: "Loops", description: "for, while, range, and loop patterns." },
  { slug: "lists", chapter: 10, title: "Lists", description: "Ordered mutable sequences and methods." },
  { slug: "tuples", chapter: 11, title: "Tuples", description: "Immutable sequences and unpacking." },
  { slug: "sets", chapter: 12, title: "Sets", description: "Unique items and set operations." },
  { slug: "dictionaries", chapter: 13, title: "Dictionaries", description: "Key–value maps and dict methods." },
  { slug: "functions", chapter: 14, title: "Functions", description: "def, arguments, return, and docstrings." },
  { slug: "scope", chapter: 15, title: "Scope", description: "Local vs global names." },
  { slug: "error-handling", chapter: 16, title: "Error Handling", description: "try/except, raise, and tracebacks." },
  { slug: "files", chapter: 17, title: "Files", description: "Read, write, and pathlib." },
  { slug: "modules", chapter: 18, title: "Modules", description: "import and organize code in files." },
  {
  ...
  { slug: "comprehensions", chapter: 21, title: "Comprehensions", description: "List, dict, and set comprehensions." },
  {
  ...
  { slug: "decorators", chapter: 25, title: "Decorators", description: "Wrap functions to add behavior." },
  { slug: "type-hints", chapter: 26, title: "Type Hints", description: "Annotations and optional mypy checks." },
  {
  ...
  { slug: "testing", chapter: 29, title: "Testing Python Code", description: "assert, pytest, and unittest." },
  { slug: "clean-code", chapter: 30, title: "Writing Clean Python", description: "Style tools and readable code habits." },
  {
    slug: "mini-programs",
    chapter: 31,
