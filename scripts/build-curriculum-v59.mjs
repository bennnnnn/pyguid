...
const SLUG_MAP = {
  ...
  "how-computers-follow-instructions": { chapter: 1 },
  "history-of-programming": { chapter: 1 },
  "what-is-python": { chapter: 1 },
  "why-python-is-beginner-friendly": { chapter: 1 },
  "what-is-python-used-for": { chapter: 1 },
  "why-learn-python": { chapter: 1 },
  "how-to-study-python": { chapter: 1 },

  "what-python-code-looks-like": { chapter: 2 },
  "top-to-bottom": { chapter: 2 },
  "first-print": { chapter: 2 },
  "printing-text-and-numbers": { chapter: 2 },
  "printing-multiple-values": { chapter: 2 },
  "escape-characters": { chapter: 2 },
  "statements-and-expressions": { chapter: 2 },
  "output-vs-result": { chapter: 2 },
  "python-syntax-basics": { chapter: 2 },
  "indentation-preview": { chapter: 2 },
  "common-beginner-mistakes": { chapter: 2 },
  "what-are-comments": { chapter: 3 },
  "single-line-comments": { chapter: 3 },
  "inline-comments": { chapter: 3 },
  "commenting-out-code": { chapter: 3 },
  "good-comments-vs-bad": { chapter: 3 },
  "comments-recap": { chapter: 3 },
  "errors-are-normal": { chapter: 4 },
  "what-is-syntax-error": { chapter: 4 },
  "missing-quotes-parentheses": { chapter: 4 },
  "wrong-capitalization": { chapter: 4 },
  ...
  "good-variable-names": { chapter: 5 },
  "reassigning-variables": { chapter: 5 },
  "updating-variable-values": { chapter: 5 },
  "variables-with-print": { chapter: 5 },
  "multiple-assignment": { chapter: 5 },
  "swapping-variables": { chapter: 5 },
  "constants-by-convention": { chapter: 5 },
  "common-variable-mistakes": { chapter: 5 },

  "input-basics": { chapter: 6, section: "What is input()?" },
  "input-conversion": { chapter: 7, section: "Converting user input" },

  "data-types-overview": { chapter: 8, section: "Core data types" },
  "type-function": { chapter: 8, section: "type()" },
  "isinstance-basics": { chapter: 8, section: "isinstance()" },
  "none-type": { chapter: 8, section: "None" },
  "mutable-immutable": { chapter: 8, section: "Mutable vs immutable" },

  "integers-floats": { chapter: 9, section: "Integers and floats" },
  "math-random-module": { chapter: 9, section: "math and random preview" },

  "arithmetic-operators": { chapter: 10, section: "Arithmetic operators" },
  "assignment-operators": { chapter: 10, section: "Assignment operators" },
  "operator-precedence": { chapter: 10, section: "Operator precedence" },
  "tip-calculator-project": { chapter: 10, section: "Mini project" },
